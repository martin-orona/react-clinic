...
1. Create the initial project.
   ...
   This project uses [react-scripts-ts](https://github.com/wmonk/create-react-app-typescript#tldr) to create a React app that uses [TypeScript](https://www.typescriptlang.org/) for easier project management over time; especially as a project gets larger or is maintained by multiple people.

2. Organize the project into a Client and Server
   ...
   1.1. Create the app: done in step 1.

   asdf

   1.2. Create the client directory.

   `mkdir client`

   1.3. Move the React content into the Client directory.
  
   I moved over the directories: `public, src`.

   I moved over the files: `images.d.ts, tsconfig.json, tsconfig.prod.json, tsconfig.test.json, tslint.json`.
